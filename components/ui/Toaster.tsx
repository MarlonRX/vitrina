  ...
  return (
    ...
    >
      <p
        ref={pillRef}
        data-state="0"
        className="flex max-w-full items-center gap-2 rounded-full border border-(--accent-primary)/40 bg-(--accent-hover) px-4 py-2.5 text-sm font-medium text-(--text-inverted) shadow-xl transition-[transform,opacity] duration-250 data-[state='0']:translate-y-3 data-[state='0']:opacity-0"
      >
